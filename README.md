...
<h3>💫 About Me</h3>
  <ul>
    ...
    <li>📜 Certified in <strong>CKS</strong>, <strong>CKAD</strong>, <strong>CKA</strong>, <strong>AWS SAA</strong>, <strong>AWS CCP</strong>, <strong>Azure Fundamentals</strong> and <strong>Cisco Network Security</strong></li>
